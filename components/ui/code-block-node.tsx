...
import {
  CopyButton as AnimatedCopyButton,
...
export default function CopyButtonDemo({ variant, size }: CopyButtonDemoProps) {
  return (
    <AnimatedCopyButton variant={variant} size={size} content="Hello world!" />
  );
}
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          size="default"
          variant="ghost"
          className="h-8 select-none rounded-sm justify-between gap-1 px-2 text-muted-foreground text-xs"
          aria-expanded={open}
          role="combobox"
        >
